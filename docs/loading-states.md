...
- [ ] The error and empty guards (`ErrorShow`, `NoContent`) are also in place, right after the skeleton check — see [Anatomy of a data-fetching page](./pages.md#anatomy-of-a-data-fetching-page).
